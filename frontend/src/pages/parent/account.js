  ...
  const fetchAccountDetails = async () => {
    try {
      ...
      const response = await axios.get(
        "http://localhost:5000/api/parents/parent-details",
        {
          headers: {
      ...
      <div className="max-w-4xl mx-auto p-8 bg-white shadow-lg rounded-lg mt-20 scroll-hidden overflow-y-auto">
        ...
        {accountDetails && !isEditing && (
          <div>
            ...
            <div className="flex justify-between mb-4">
              <span className="text-lg font-medium">Relationship:</span>
              <span className="text-lg">{accountDetails.relationship}</span>
            </div>
            <div className="flex justify-between mb-4">
